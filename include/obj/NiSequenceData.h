...
#ifndef _NISEQUENCEDATA_H_
#define _NISEQUENCEDATA_H_
...
typedef Ref<NiSequenceData> NiSequenceDataRef;
 ...
 */
class NiSequenceData : public NiObject {
public:
	/*! Constructor */
	NIFLIB_API NiSequenceData();
	
	/*! Destructor */
	NIFLIB_API virtual ~NiSequenceData();
...
protected:
	...
	mutable unsigned int numEvaluators;
	vector<Ref<NiEvaluator > > evaluators;
