...
#ifndef _NIPSBOUNDUPDATER_H_
#define _NIPSBOUNDUPDATER_H_
...
typedef Ref<NiPSBoundUpdater> NiPSBoundUpdaterRef;

/*! Updates the bounding volume for an NiPSParticleSystem object. */
class NiPSBoundUpdater : public NiObject {
public:
	/*! Constructor */
	NIFLIB_API NiPSBoundUpdater();
	
	/*! Destructor */
	NIFLIB_API virtual ~NiPSBoundUpdater();
