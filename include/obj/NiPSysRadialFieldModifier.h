...
#ifndef _NIPSYSRADIALFIELDMODIFIER_H_
#define _NIPSYSRADIALFIELDMODIFIER_H_
...
typedef Ref<NiPSysRadialFieldModifier> NiPSysRadialFieldModifierRef;
...
public:
	/*! Constructor */
	NIFLIB_API NiPSysRadialFieldModifier();
	
	/*! Destructor */
	NIFLIB_API virtual ~NiPSysRadialFieldModifier();
