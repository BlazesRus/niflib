...
/*!
 * Abstract base class for all NiInterpControllers that use a NiInterpolator to
 * animate their target boolean value.
 */
...
public:
	...
	/*! Destructor */
	NIFLIB_API virtual ~NiBoolInterpController();
