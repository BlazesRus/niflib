...
#ifndef _BSLIGHTINGSHADERPROPERTYFLOATCONTROLLER_H_
#define _BSLIGHTINGSHADERPROPERTYFLOATCONTROLLER_H_
...
public:
	/*! Constructor */
	NIFLIB_API BSLightingShaderPropertyFloatController();
	
	/*! Destructor */
	NIFLIB_API virtual ~BSLightingShaderPropertyFloatController();
