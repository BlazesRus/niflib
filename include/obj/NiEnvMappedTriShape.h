...
#ifndef _NIENVMAPPEDTRISHAPE_H_
#define _NIENVMAPPEDTRISHAPE_H_
...
typedef Ref<NiEnvMappedTriShape> NiEnvMappedTriShapeRef;

/*! Unknown */
class NiEnvMappedTriShape : public NiObjectNET {
public:
	/*! Constructor */
	NIFLIB_API NiEnvMappedTriShape();
	
	/*! Destructor */
	NIFLIB_API virtual ~NiEnvMappedTriShape();
