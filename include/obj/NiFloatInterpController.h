...
/*!
 * Abstract base class for all NiInterpControllers that use an NiInterpolator to
 * animate their target float value.
 */
...
public:
	...
	/*! Destructor */
	NIFLIB_API virtual ~NiFloatInterpController();
