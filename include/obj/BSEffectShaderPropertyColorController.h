...
#ifndef _BSEFFECTSHADERPROPERTYCOLORCONTROLLER_H_
#define _BSEFFECTSHADERPROPERTYCOLORCONTROLLER_H_
...
class BSEffectShaderPropertyColorController : public NiPoint3InterpController {
public:
	/*! Constructor */
	NIFLIB_API BSEffectShaderPropertyColorController();
	
	/*! Destructor */
	NIFLIB_API virtual ~BSEffectShaderPropertyColorController();
