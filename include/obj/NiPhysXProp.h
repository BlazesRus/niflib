...
#ifndef _NIPHYSXPROP_H_
#define _NIPHYSXPROP_H_
...
protected:
	...
	vector<Ref<NiObject > > sources;
	mutable int numDests;
	vector<Ref<NiPhysXDest > > dests;
	mutable unsigned int numModifiedMeshes;
	vector<Ref<NiMesh > > modifiedMeshes;
