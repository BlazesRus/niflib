...
#ifndef _NIPSSPAWNER_H_
#define _NIPSSPAWNER_H_
...
class NiPSSpawner;
typedef Ref<NiPSSpawner> NiPSSpawnerRef;

/*!
 * Creates a new particle whose initial parameters are based on an existing
 * particle.
 */
class NiPSSpawner : public NiObject {
public:
	/*! Constructor */
	NIFLIB_API NiPSSpawner();
	
	/*! Destructor */
	NIFLIB_API virtual ~NiPSSpawner();
...
protected:
	...
	unsigned int minToSpawn;
	unsigned int maxToSpawn;
public:
