...
#ifndef _BSLAGBONECONTROLLER_H_
#define _BSLAGBONECONTROLLER_H_
...
typedef Ref<BSLagBoneController> BSLagBoneControllerRef;

/*! A controller that trails a bone behind an actor. */
class BSLagBoneController : public NiTimeController {
public:
	/*! Constructor */
	NIFLIB_API BSLagBoneController();
	
	/*! Destructor */
	NIFLIB_API virtual ~BSLagBoneController();
