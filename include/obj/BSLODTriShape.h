...
#ifndef _BSLODTRISHAPE_H_
#define _BSLODTRISHAPE_H_
...
public:
	/*! Constructor */
	NIFLIB_API BSLODTriShape();
	
	/*! Destructor */
	NIFLIB_API virtual ~BSLODTriShape();
	...
	//--END CUSTOM CODE--//
protected:
	unsigned int lod0Size;
	unsigned int lod1Size;
	unsigned int lod2Size;
public:
