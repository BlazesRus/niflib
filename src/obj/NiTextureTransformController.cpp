...
NiTextureTransformController::NiTextureTransformController() : shaderMap(false), textureSlot((TexType)0), operation((TransformMember)0), data(NULL) {
